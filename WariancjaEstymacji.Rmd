...
colors <- c('Niepoprawne Założenie' = '#DB473B',
            'Poprawne Założenie' = '#009E73')
...
plot_sd <- function(sd, variable, mod, dis, cap, interval) {
  ...
  ggplot(key_glyph = draw_key_rect) +
    geom_line(aes(x = n, y = std_err, color = 'Niepoprawne Założenie')) +
    geom_line(aes(x = n, y = std, color = 'Poprawne Założenie')) +
